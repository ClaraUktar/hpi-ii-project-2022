...
protoc --proto_path=proto --python_out=build/gen proto/bakdata/corporate/v2/duplicate_company.proto
protoc --proto_path=proto --python_out=build/gen proto/bakdata/corporate/v2/deleted_company.proto
